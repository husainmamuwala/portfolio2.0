...
function About({}: Props) {
  return (
    ...
    max-w-7xl px-10 justify-evenly mx-auto items-center '>
        ...
        <p>Im Husain , A Front End UI/UX developer ive worked with a budding startup to help them scale and grow
            Along that journey i found my inclined towards delivering the best 
        </p>
        </div>        
    </div>
  )
