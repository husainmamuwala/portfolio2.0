...
function About({}: Props) {
  return (
    ...
    max-w-7xl px-10 justify-evenly mx-auto items-center '>
        ...
        <p>Im Husain , A Front End UI/UX developer. I have worked with a budding startup to help them scale and grow their company
            .Along that journey i also found myself inclined towards building a clean and friendly UI . I have worked over multiple
            projects and Graphic Designs 
        </p>
        </div>        
    </div>
  )
