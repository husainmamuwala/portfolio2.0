...
function About({}: Props) {
  return (
    ...
    max-w-7xl px-10 justify-evenly mx-auto items-center '>
        ...
        className='-mb-20 md:mb-0 flex-shrink-0 w-64 h-64 rounded-full object-cover md:rounded-xl md:h-96 md:w-96 xl:w-[500px] xl:[]'
        />
        ...
        <p className='text-base md:text-lg'>Hi, I’m Husain! I'm a <span className='text-[#1f9aec]'>web developer</span> with in-depth experience in UI/UX design. In a nutshell,
