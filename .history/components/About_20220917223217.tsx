...
function About({}: Props) {
  return (
    ...
    max-w-7xl px-10 justify-evenly mx-auto items-center '>
        ...
        <h4 className='text-3xl font-semibold md:text-5xl'>Here's A <span className='underline decoration-[#1f9aec]'>Little</span> Background</h4>    
        <p className='text-sm md:lg'>Hi, I’m Husain! I'm a <span className='text-[#1f9aec]'>web developer</span> with in-depth experience in UI/UX design. In a nutshell,
