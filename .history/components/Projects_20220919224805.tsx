             ...
             space-y-5 md:p-44 xl:p-60 h-screen'>
                ...
                <div>
                    <h4 className='text-l text-center'> 
                      ...
                      <p className='max-w-lg text-center md:max-w-'>lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum
