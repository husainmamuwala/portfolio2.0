...
function About({}: Props) {
  return (
    ...
    max-w-7xl px-10 justify-evenly mx-auto items-center '>
        ...
        <p>Hi, I’m Husain! I'm a <span className='text-[Hi, I’m Husain! I'm a web developer with in-depth experience in UI/UX design. In a nutshell, I create websites that help organizations address business challenges and meet their needs. I manage everything from website navigation and layout to a company's web hosting and security architecture. My expertise lies within front-end web apps, and the main languages in my tech stack are Next ,React, and of course HTML/CSS. I’m a lifelong learner (currently taking a course on building AI chatbots with Python!) and love to Cycle,Trek, and find The best food spots in Mumbai City.]'></span>web developer with in-depth experience in UI/UX design. In a nutshell,
