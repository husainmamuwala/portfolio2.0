...
export default function Hero({}: Props) {
  ...
  return (
    <div className='h-screen flex flex-col items-center justify-center space-y-4 overflow-hidden text-center'>
        <BackgroundCircles/>
        <img 
        ...
        <h1 className='text-4xl lg:text-6xl font-semibold px-36'>
