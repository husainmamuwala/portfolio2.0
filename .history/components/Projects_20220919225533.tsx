             ...
             space-y-5 md:p-44 xl:p-60 h-screen'>
                ...
                <div className="space-y-10 px-0 md:px-10 max-w-6xl">
                    <h4 className='text-l text-center font-semibold'> 
                      ...
                      <p className='max-w-lg text-center md:max-w-3xl p-2'>lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum
