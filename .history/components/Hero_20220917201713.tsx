...
export default function Hero({}: Props) {
  ...
  return (
    <div className='h-screen flex flex-col items-center justify-center space-y-6 overflow-hidden text-center z-20'>
        <BackgroundCircles/>
        <img 
        ...
        <h2 className='test-sm uppercase text-gray-500 pb-1 tracking-[15px] z-20'>Software Engineer</h2>
